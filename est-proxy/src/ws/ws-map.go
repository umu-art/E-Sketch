...
func (connMap *ConnectionsMap) Save(boardId uuid.UUID, conn *Connection) {
	connMap.lock.Lock()
...
func (connMap *ConnectionsMap) Remove(boardId uuid.UUID, conn *Connection) {
	connMap.lock.Lock()
	defer connMap.lock.Unlock()
...
func (connMap *ConnectionsMap) GetConnections(boardId uuid.UUID) []*Connection {
	connMap.lock.RLock()
