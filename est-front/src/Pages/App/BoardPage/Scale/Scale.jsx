...
const ScaleElement = ({ style }) => {
  ...
  const updateScale = useCallback(() => {
    const newScale = drawing.scale * 100;
  ...
  const lastScale = useRef(drawing.scale);
  ...
  const updatePosition = useCallback(() => {
    ...
    if (Date.now() - lastScaleChangeTime.current > 1000) {
  ...
  return (
    <div style={{
      ...
      <svg width="170" height="170" viewBox="0 0 170 170" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg x="51" y="51" width="250" height="250" viewBox="0 0 115 115"
        ...
        <g transform={`rotate(${rotate} 170 170)`}>
          <g transform="rotate(105 170 170)">
            <text fill="black" x="63" y="175" fontFamily="Arial" fontSize="15">{round(referenceScale * baseC ** 3)}%
            </text>
            <rect x="115" y="170" width="7" height="0.5" rx="1" fill="black" stroke="black" />
          </g>
          <g transform="rotate(85 170 170)">
            <text fill="black" x="63" y="175" fontFamily="Arial" fontSize="15">{round(referenceScale * baseC ** 2)}%
            </text>
            <rect x="115" y="170" width="7" height="0.5" rx="1" fill="black" stroke="black" />
          </g>
          <g transform="rotate(65 170 170)">
            <text fill="black" x="63" y="175" fontFamily="Arial" fontSize="15">{round(referenceScale * baseC ** 1)}%
            </text>
            <rect x="115" y="170" width="7" height="0.5" rx="1" fill="black" stroke="black" />
          </g>
          <g transform="rotate(45 170 170)">
            <text fill="black" x="63" y="175" fontFamily="Arial" fontSize="15">{round(referenceScale)}%</text>
            <rect x="115" y="170" width="7" height="0.5" rx="1" fill="black" stroke="black" />
          </g>
          <g transform="rotate(25 170 170)">
            <text fill="black" x="63" y="175" fontFamily="Arial"
                  fontSize="15">{round(referenceScale / baseC ** 1)}%
            </text>
            <rect x="115" y="170" width="7" height="0.5" rx="1" fill="black" stroke="black" />
          </g>
          <g transform="rotate(5 170 170)">
            <text fill="black" x="63" y="175" fontFamily="Arial"
                  fontSize="15">{round(referenceScale / baseC ** 2)}%
            </text>
            <rect x="115" y="170" width="7" height="0.5" rx="1" fill="black" stroke="black" />
          </g>
          <g transform="rotate(-15 170 170)">
            <text fill="black" x="63" y="175" fontFamily="Arial"
                  fontSize="15">{round(referenceScale / baseC ** 3)}%
            </text>
            <rect x="115" y="170" width="7" height="0.5" rx="1" fill="black" stroke="black" />
          </g>
        </g>
