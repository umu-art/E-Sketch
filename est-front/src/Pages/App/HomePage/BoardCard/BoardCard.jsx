    ...
    return (
        <Card
            ...
            cover={
                <Image height={175}
                    fallback="data:image/png;base64,"
                    src={'/preview?boardId=' + data.id + '&token=' + data.preview}
                    style={{ objectFit: "cover", cursor: "pointer" }}
                    preview={false}
        ...
        >
            <Modal
                ...
                onCancel={() => setUpdateBoardModalOpen(false)}
                footer={null}
            >
                <UpdateBoardForm data={data} onDataChange={setData} closeModal={() => setUpdateBoardModalOpen(false)}/>
            </Modal>
            <Meta
                avatar={<Avatar src={"https://api.dicebear.com/7.x/miniavs/svg?seed=" + data.ownerInfo.id}/>}
                title={data.name}
                description={<div style={{ maxHeight: 22, minHeight: 22, whiteSpace: "pre-wrap" }}>
